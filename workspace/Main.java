...
public class Main 
{
  ...
  */
  public void showCountry() {
    ...
    String imagefile = c.getImageFileName();
  ...
  {
    Country c = countryArray[index];
    String resultCountry = c.toString();
    System.out.println(resultCountry);
    outputLabel.setText(resultCountry);
  }
  ...
  */
  public void quizButtonClick()
  {
    outputLabel.setText("");
    Country c = countryArray[index];
    System.out.print("What is this country's capital? ");
    Scanner scan = new Scanner(System.in);
    String userInput = scan.nextLine(); 
    if(userInput.equals(c.getCapital())){
